...
//    // Redis 锁 - 普通任务
//    @Scheduled(cron = "*/1 * * * * ?")
//    @SchedulerLock(name = "generateDailyReport", lockAtMostFor = "PT4M", lockAtLeastFor = "PT3S")
...
//            logEntry.setTaskName("generateDailyReport");
//            logEntry.setStatus("SUCCESS");
//            logEntry.setMessage("日报表生成完成");
...
//    // MySQL 锁 - 严格任务
//    @Scheduled(cron = "*/10 * * * * ?")
//    @SchedulerLock(name = "dailySettlement", lockAtMostFor = "PT1M", lockAtLeastFor = "PT30S")
